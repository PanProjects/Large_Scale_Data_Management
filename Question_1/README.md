...
| Format  | Size   | Run 1 (sec) | Run 2 (sec) | Run 3 (sec) | Average (sec) |
|----------|---------|-------------:|-------------:|-------------:|--------------:|
| CSV      | 896 MB | 16.681 | 26.469 | 16.820 | 19.990 |
| Parquet  | 121 MB | 4.130  | 4.830  | 4.218  | 4.393  |

---

Το Parquet είναι περίπου 4,55× πιο γρήγορο από το CSV και καταλαμβάνει σημαντικά λιγότερο χώρο, επιβεβαιώνοντας την βελτίωση λόγω του columnar format η οποία επιτρέπει column pruning, και την πιο αποδοτική συμπίεση δεδομένων με μειωμένο I/O κατά την ανάγνωση.
