...
RESULT_PATH = f"{HDFS_ROOT}/user/{DSML_USER}/results/Q2_df_result"

spark = SparkSession.builder.appName("Q2_DataFrame").getOrCreate()
...
print("\n=== Query 1 Results (DataFrame - no UDF) ===")
start = perf_counter()
result_df.show()
