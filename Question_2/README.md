...
| Υλοποίηση | Run (sec) |
|---|---|
| DataFrame (no UDF) | 18.213 |
| DataFrame (UDF) | 39.522 | 
| RDD | 85.638 |

Η Dataframe χωρίς την UDF είναι 2.17 φορές ταχύτερη από αυτή με UDF και 4.7 φορές ταχύτερη από την RDD υλοποίηση. 
